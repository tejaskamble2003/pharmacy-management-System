...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2024 at 10:47 PM
...
(10, '2019-03-29', NULL, 'Purchase Medicine', 2, 'Tablet', 3, 'Ace Plus', 7, 'Paracetamol', 5, 'Square Pharmaceuticals Ltd.', 2.52, 184, 504, 3, 'Pcs', 350, 154, '2021-01-01'),
(12, '2019-03-30', NULL, 'Purchase Medicine', 2, 'Tablet', 2, 'Napa Extra', 7, 'Paracetamol', 4, 'Beximco Pharmaceuticals Ltd.', 2.5, 190, 500, 3, 'Pcs', 300, 200, '2020-01-01'),
...
CREATE TABLE `sales_product` (
  ...
  `customer_cno` int(10) DEFAULT NULL,
...
INSERT INTO `sales_product` (`sales_id`, `date`, `invoice`, `particular`, `customer_id`, `customer_name`, `mobile`, `customer_email`, `medicine_presentation_id`, `medicine_presentation`, `medicine_name_id`, `medicine_name`, `generic_id`, `generic_name`, `qty`, `unit_sales_price`, `total_price`, `total_amount`, `total_discount`, `discount_price`, `sales_paid`, `sales_due`, `customer_cno`, `doctor_name`, `pan_no`) VALUES
(1, '2019-04-06', 1, 'Sales Medicine', NULL, NULL, '', 'bmmahmud@gmail.com', NULL, 'Tablet', 3, 'Ace Plus', NULL, 'Paracetamol', 10, 3, 30, 120, 5, 115, 115, NULL, NULL, NULL, NULL),
(2, '2019-04-06', 1, 'Sales Medicine', NULL, NULL, '', 'bmmahmud@gmail.com', NULL, 'Tablet', 2, 'Napa Extra', NULL, 'Paracetamol', 30, 3, 90, 120, 5, 115, 115, NULL, NULL, NULL, NULL),
(3, '2019-03-31', 2, 'Sales Medicine', NULL, NULL, '', 'bmmahmud@gmail.com', NULL, 'Tablet', 0, 'Amdocal 10', NULL, 'Amlodipine', 10, 7, 70, 70, 0, 70, 70, NULL, NULL, NULL, NULL),
(4, '2021-08-03', 3, 'Sales Medicine', NULL, NULL, '', 'bmmahmud@gmail.com', NULL, 'Tablet', 9, 'Niko', NULL, 'Paracetamol', 47, 2, 94, 94, 2, 92, 94, NULL, NULL, NULL, NULL),
(5, '2021-08-17', 4, 'Sales Medicine', NULL, NULL, '', 'testacc@gmail.com', NULL, 'Tablet', 9, 'Niko', NULL, 'Paracetamol', 17, 2, 34, 34, 0, 34, 34, NULL, NULL, NULL, NULL),
(6, '2021-08-17', 5, 'Sales Medicine', NULL, NULL, '', 'test22@gmail.com', NULL, 'Tablet', 0, 'Amdocal 5', NULL, 'Amlodipine', 66, 4.5, 297, 297, 2, 295, 295, NULL, NULL, NULL, NULL),
(7, '2021-08-17', 6, 'Sales Medicine', NULL, NULL, '', 'jamesr@gmail.com', NULL, 'Tablet', 11, 'Xyzal', NULL, 'Levocetirizine Dihydrochloride', 46, 0.55, 25.3, 25.3, 0, 25.3, 25.3, NULL, NULL, NULL, NULL),
(8, '2024-03-10', 7, 'Sales Medicine', NULL, NULL, '', '1234455677', NULL, 'Tablet', 3, 'Ace Plus', NULL, 'Paracetamol', 12, 3, 36, 36, 0, 36, 123, NULL, NULL, NULL, NULL),
(9, '2024-03-14', 8, 'Sales Medicine', NULL, NULL, '', '', NULL, 'Tablet', 3, 'Ace Plus', NULL, 'Paracetamol', 2, 3, 6, 6, 2, 4, 100, NULL, 2147483647, NULL, NULL),
(10, '2024-03-14', 9, 'Sales Medicine', NULL, NULL, '', 'abcd@gmail.com', NULL, 'Tablet', 3, 'Ace Plus', NULL, 'Paracetamol', 2, 3, 6, 6, 1, 5, 100, NULL, 1234567890, NULL, NULL),
(11, '2024-03-14', 10, 'Sales Medicine', NULL, NULL, '', 'xyz@gmail.com', NULL, 'Tablet', 2, 'Napa Extra', NULL, 'Paracetamol', 2, 3, 6, 6, 1, 5, 200, NULL, 1234567890, NULL, NULL),
(12, '2024-03-14', 11, 'Sales Medicine', NULL, NULL, '', 'raj@gmail.com', NULL, 'Tablet', 2, 'Napa Extra', NULL, 'Paracetamol', 2, 3, 6, 6, 1, 5, 100, NULL, 1234546789, 'Raj', 'ABCD12455'),
(13, '2024-03-14', 12, 'Sales Medicine', NULL, NULL, '', 'rani@gmail.com', NULL, 'Tablet', 2, 'Napa Extra', NULL, 'Paracetamol', 4, 3, 12, 12, 0, 12, 200, NULL, 1234567890, 'Rani', 'Abcd12344'),
(14, '2024-03-14', 13, 'Sales Medicine', NULL, NULL, '', 'rajkumar@gmail.com', NULL, 'Tablet', 2, 'Napa Extra', NULL, 'Paracetamol', 2, 3, 6, 6, 0, 6, 1200, NULL, 1254211666, 'Rajkumar', 'ABCD123456');
...
(1, 'staff', '202cb962ac59075b964b07152d234b70', 'Staff'),
...
--
ALTER TABLE `insert_purchase_info`
  MODIFY `purchase_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111;

--
-- AUTO_INCREMENT for table `sales_product`
--
ALTER TABLE `sales_product`
  MODIFY `sales_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
