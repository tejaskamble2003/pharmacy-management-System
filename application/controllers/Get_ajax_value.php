	...
	public function sales_confirm() {
		...
		$medicine_collection="";
			...
			foreach ($all_purchase as $single_purchase) {
				...
				$customer_cn = $single_purchase[9];
				$pan_no = $single_purchase[10];
				$doctor_name = $single_purchase[11];
				...
				$insert_data = array(
					...
					// tk changes Add Customer Mobile No
					'customer_cno' => $customer_cn,
