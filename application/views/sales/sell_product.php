							...
							<div class="row">
								...
								<div class="col-sm-4" style="">
									...
									<input type="text" class="form-control" autocomplete="off"
										   placeholder="Enter Doctor name" name="doctor_name" id="doctor_name"
								...
								<div class="col-sm-3" style="">
									<label for="customer_mno">Customer Mobile No</label>
									<input type="text" class="form-control" maxlength="10" autocomplete="off"
										   placeholder="Enter mobile no" name="customer_cn" id="customer_cn"
										   autocomplete="off" required>
								</div>
								...
								<div class="col-sm-4">
									...
									<input type="textfield" class="form-control" placeholder="Enter PAN no" maxlength="15" id="pan_no" name="pan_no" >
								</div>
...
<script type="text/javascript">
	...
	$("#add_item").click(function () {
		...
		all_purchase[product_count] = new Array(date,medicine_name,unit_sales_price,qty,purchase_price,
			medicine_name_id, generic_name, medicine_presentation, customer_email,customer_cn,pan_no,doctor_name);
		var full_table = "";
		var test_total = 0;
